    ...
    <div>
      ...
      <div class="">
        <div class="flex justify-center">
          <img
            src={MobileApp1}
            class="rounded-xl h-96 m-0 p-0 mx-10"
          ...
          <div class="w-1/5 text-3xl">
            ...
            <br />
            <a
              class="py-5 bg-teal-500 text-white p-2 text-2xl rounded-3xl font-bold duration-200 hover:bg-teal-600"
        ...
        <div class="flex justify-center my-20">
          <div class="w-1/5 text-3xl">
            ...
            <br />
            <a
              class="py-5 bg-indigo-500 text-white p-2 text-2xl rounded-3xl font-bold duration-200 hover:bg-indigo-600"
              href="https://play.google.com/store/apps/details?id=org.creativeblogger.org&hl=fr"
            >
              Téléchargez-là
            </a>
        ...
        <div class="flex justify-center mb-10">
          <img src={MobileApp3} class="rounded-xl h-96 m-0 p-0 mx-10" alt="" />
          <div class="w-1/5 text-3xl">
