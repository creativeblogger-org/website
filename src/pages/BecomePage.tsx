...
const BecomePage: Component = () => {
  ...
  return (
    <div>
      <h1 class="text-center mt-5 mb-10 text-3xl">Rejoindre notre équipe</h1>
      ...
      {showDiv2() ? (
        ...
        >
          ...
          <img class="" src={Unique} alt="Car Creative Blogger est unique" />
          <h1 class="text-transparent bg-clip-text bg-gradient-to-br from-teal-500 to-indigo-500 text-3xl text-center">
            Car Creative Blogger est unique
          </h1>
          <p class="text-white p-4">
            Creative Blogger est unique dans le paysage blogging français de par
            son idéologie du libre et gratuit, mais également par notre
            marketing et notre design. Nous rejoindre, c'est rejoindre un
            mouvement jamais vu en France, et, comme dit le dicton " il y a une
