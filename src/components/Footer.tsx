    ...
    <footer class="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 p-8 mx-auto w-full bottom-0">
      <div class="grid grid-cols-1 sm:grid-cols-2 w-full">
        <div class="about-us-container sm:flex-col w-full">
          <h1 class="uppercase text-white font-pangolin text-center sm:text-justify">
            <img
              src={CBLogo}
          ...
          <p class="text-white hidden sm:block w-3/4 font-garamond md:text-xl text-base">
          ...
          <div class="hidden sm:visible sm:grid grid-cols-7 w-3/5 sm:w-4/5 lg:3/5 md:w-3/5 xl:w-2/5 my-2">
            <NavLink
